...
with st.container(key="upload", border=True):
    uploaded_files = st.file_uploader("Upload a Depth Map", type=["png"], accept_multiple_files = True)
    ...
    if uploaded_files:
        ...
        for uploaded_file in uploaded_files:
            ...
            display.append(image.convert("RGB")) # Converting to RGB because Streamlit cannot display greyscale images
        st.image(display)
